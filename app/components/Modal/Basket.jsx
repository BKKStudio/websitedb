...
export default function BasketModal({
  ...
  return (
    <React.Fragment>
      {/* Backdrop */}
      <div
        className={`fixed w-full h-full z-110 flex justify-end z-50 ${
          MarketOpen ? "visible bg-black/60" : "invisible"
        }`}
      >
        {/* Modal */}
        <div
          className={`${
            MarketOpen
              ? "lg:w-[584px] overflow-hidden max-lg:w-full opacity-100 duration-500 "
              : "w-0 opacity-0 duration-500"
          ...
          <div className="w-full flex justify-end">
            <div className="w-full  flex justify-center py-4 h-screen">
              <div className="w-full px-4 flex flex-col gap-3">
                ...
                <div
                  className={` rounded-xl w-full flex overflow-hidden justify-between p-3 ${
                ...
                <div
                  className={`rounded-xl w-full flex overflow-auto justify-between p-3 ${
                    theme == "dark" ? "" : "bg-gray-200"
                  }`}
                >
                  <div className="w-full h-[584px] flex flex-col gap-2">
                    ...
                    {cart.map((data) => (
                      <div
                        className="flex justify-between gap-2 pr-4"
                        key={data.id}
                      >
                        <div className="flex items-center gap-2">
                          ...
                          />
                          <img src={data.img} alt="" className="w-1/5" />
                ...
                <button
                  className="p-3 bg-yellow-500 text-white text-xl font-bold rounded-xl"
                  type=""
                >
                  ชำระเงิน
                </button>
